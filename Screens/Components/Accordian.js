...
export default function Accordian({ itemid, listdata, title, onChildEditClick ,onChildDeleteClick}) {
        ...
        <View>
            <TouchableOpacity style={styles.row} onPress={() => toggleExpand()}>
                ...
                <AntDesign name="edit" size={24} color="black"
                    onPress={() => onChildEditClick(itemid)}
                    style={styles.icons} />

                <AntDesign name="delete" size={24} color="black"
                    onPress={() => onChildDeleteClick(itemid)}
                    style={styles.icons} />
